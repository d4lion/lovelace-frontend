...
import { SuggestionHistoryReqComponent } from './pages/suggestion-history-req/suggestion-history-req.component';
...
export const routes: Routes = [
    ...
    {path: 'suggestion/history/:id', component: SuggestionHistoryReqComponent}
];
